...
When the user provides files in the workspace (competitor pricing, survey data, financial models, or usage data), read them first. Use the `search_web` tool to research competitor pricing if needed.
