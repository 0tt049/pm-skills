...
1. **Gather Information**: When the user provides files in the workspace, read them carefully. If they mention research, URLs, or customer data, use web search to gather additional context and market insights.
