---
name: product_brainstorm-ideas-existing
...
When the user provides files in the workspace (research data, opportunity trees, personas), read them first. If they mention a product URL, use web search to understand the product.
