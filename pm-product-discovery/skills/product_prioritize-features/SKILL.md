---
name: product_prioritize-features
...
When the user provides files in the workspace (spreadsheets, backlogs, opportunity assessments), use the `view_file` tool to read the contents of the files.
