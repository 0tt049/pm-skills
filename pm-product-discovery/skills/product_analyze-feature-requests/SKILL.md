---
name: product_analyze-feature-requests
...
When the user provides files in the workspace (spreadsheets, CSVs, or documents with feature requests), use the `view_file` tool to read the contents of the files. If data is in a structured format, consider creating a summary table.
