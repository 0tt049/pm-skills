---
name: product_brainstorm-ideas-new
...
When the user provides files in the workspace (market research, competitive analysis), read them first. Use the `search_web` tool to understand the market if needed.
