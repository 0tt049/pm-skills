...
If the user provides data files (CSV, Excel, or analytics exports), use the `view_file` tool to read the contents of the files. Generate Python scripts for statistical calculations when needed.
