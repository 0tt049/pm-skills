---
name: product_shipping-artifacts
...
- The agent operating-context file (`AGENTS.md` / `AGENTS.md`) is a *different* artifact — instructions derived from these docs, not system documentation. It is produced at the handoff step by `/ship-check`, not here.
