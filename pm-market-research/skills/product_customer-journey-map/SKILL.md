---
name: product_customer-journey-map
...
When the user provides files in the workspace (interview transcripts, survey data, analytics, support tickets, or existing journey maps), read them first. Use the `search_web` tool to understand the product if a URL is provided.
