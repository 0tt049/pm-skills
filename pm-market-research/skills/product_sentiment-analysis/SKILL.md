---
name: product_sentiment-analysis
...
If the user provides CSV files, PDFs, survey responses, review data, social listening reports, or other feedback sources, use the `view_file` tool to read the contents of the files. Extract patterns, themes, and sentiment signals from the data.
