---
name: product_user-segmentation
...
If the user provides feedback data, interviews, support tickets, product usage logs, surveys, or other user data, use the `view_file` tool to read the contents of the files. Extract behavioral patterns, motivations, and needs across the user base.
