...
If the user provides CSV, Excel, survey responses, interview transcripts, or other research data files, use the `view_file` tool to read the contents of the files using available tools. Extract key patterns, demographics, motivations, and behaviors.
