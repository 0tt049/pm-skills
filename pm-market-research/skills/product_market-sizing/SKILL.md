...
If the user provides market research, industry reports, financial data, or competitor information, use the `view_file` tool to read the contents of the files. Use the `search_web` tool to find current market data, industry reports, and growth projections.
...
- Use the `search_web` tool for current industry data, analyst reports, and market benchmarks
