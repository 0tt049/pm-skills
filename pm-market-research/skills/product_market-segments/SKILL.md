...
If research data, market studies, customer databases, or existing segmentation documents are provided, use the `view_file` tool to read the contents of the files. Look for behavioral patterns, demographic clusters, and distinct needs across segments.
