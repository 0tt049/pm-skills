---
name: product_competitive-battlecard
...
Use the `search_web` tool to research the competitor's current product, pricing, positioning, and recent changes. When the user provides files in the workspace (feature lists, win/loss data, sales call notes), read them first.
